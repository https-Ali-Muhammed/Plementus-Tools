...
export function reportFamilyDocument({ toolName, title, projectName, subtitle, generatedAt, metadata = [], chips = [], notice = '', metrics = [], sections = [], eyebrowColor = REPORT_FAMILY_TOKENS.accent }) {
  const safeEyebrowColor = /^#[0-9a-f]{6}$/i.test(eyebrowColor) ? eyebrowColor : REPORT_FAMILY_TOKENS.accent;
