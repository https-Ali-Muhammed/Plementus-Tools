...
| `/weak-cookies` | Session cookie lacks Secure; analytics cookie lacks Secure/SameSite | atomic cookie findings with session issue high and tracking issues low |
...
| `/payment` | Generic outsourced payment language | payment context observed, PCI scope not established |
